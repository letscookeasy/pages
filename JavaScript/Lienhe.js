var elements = document.getElementsByClassName("elementor-button elementor-size-md elementor-animation-grow");
...
function kiemTraNoiDung() {
	...
	var phoneValue = document.getElementById('form-field-field_b58bf22').value;
...
function checkForm(){  
	...
	var phone = document.getElementById('form-field-field_b58bf22').value;
...
function sendMail() {
	var params = {
	  ...
	  phone: document.getElementById("form-field-field_b58bf22").value,
	};
  
	const serviceID = "service_63snetq";
	const templateID = "template_ei4724e";
